...
export const api = {
  ...
  programSummary: (r?: YearRange, currentOnly = true, focus?: string) =>
    get<ProgramSummaryRow[]>("/program-summary", { ...yr(r), current_only: currentOnly, focus }),
  collaborationMatrix: (r?: YearRange, currentOnly = true, focus?: string) =>
